...
const models: TsoaRoute.Models = {
    ...
    "HostelStatus": {
        "dataType": "refAlias",
        "type": {"dataType":"union","subSchemas":[{"dataType":"enum","enums":["pending"]},{"dataType":"enum","enums":["approved"]},{"dataType":"enum","enums":["rejected"]},{"dataType":"enum","enums":["suspended"]}],"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Partial_IHostel_": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"status":{"ref":"HostelStatus"},"stripeAccountId":{"dataType":"string"},"logo":{"dataType":"string"},"name":{"dataType":"string"},"username":{"dataType":"string"},"address":{"dataType":"nestedObjectLiteral","nestedProperties":{"zip":{"dataType":"string"},"country":{"dataType":"string","required":true},"city":{"dataType":"string","required":true},"street":{"dataType":"string","required":true}}},"phone":{"dataType":"string"},"email":{"dataType":"string"},"website":{"dataType":"string"},"experience_with_volunteers":{"dataType":"boolean"},"currency":{"dataType":"string"},"rooms":{"dataType":"array","array":{"dataType":"refAlias","ref":"mongoose.Types.ObjectId"}},"user_id_owners":{"dataType":"array","array":{"dataType":"refAlias","ref":"mongoose.Types.ObjectId"}},"user_id_guests":{"dataType":"array","array":{"dataType":"refAlias","ref":"mongoose.Types.ObjectId"}},"user_id_staffs":{"dataType":"array","array":{"dataType":"refAlias","ref":"mongoose.Types.ObjectId"}},"events":{"dataType":"array","array":{"dataType":"refAlias","ref":"mongoose.Types.ObjectId"}},"volunteer_opportunities":{"dataType":"array","array":{"dataType":"refAlias","ref":"mongoose.Types.ObjectId"}},"policies":{"dataType":"boolean"}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "IGuestListItem": {
        "dataType": "refObject",
    ...
    "Partial_IGuest_": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"name":{"dataType":"string"},"username":{"dataType":"string"},"guest_photos":{"dataType":"array","array":{"dataType":"string"}},"phone":{"dataType":"string"},"birthday":{"dataType":"datetime"},"country":{"dataType":"string"},"showProfileAuthorization":{"dataType":"boolean"},"user":{"ref":"mongoose.Types.ObjectId"},"reservations":{"dataType":"array","array":{"dataType":"refAlias","ref":"mongoose.Types.ObjectId"}},"passaportPhoto":{"dataType":"string"},"interests":{"dataType":"array","array":{"dataType":"string"}},"description":{"dataType":"string"},"languages":{"dataType":"array","array":{"dataType":"string"}},"digitalNomad":{"dataType":"boolean"},"smoker":{"dataType":"boolean"},"pets":{"dataType":"boolean"},"instagram":{"dataType":"string"},"linkedin":{"dataType":"string"},"twitter":{"dataType":"string"}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "IGuestCurrentStay": {
        ...
        "properties": {
            ...
            "hostel": {"dataType":"nestedObjectLiteral","nestedProperties":{"email":{"dataType":"string"},"phone":{"dataType":"string"},"address":{"dataType":"nestedObjectLiteral","nestedProperties":{"country":{"dataType":"string"},"city":{"dataType":"string"},"street":{"dataType":"string"}}},"logo":{"dataType":"string"},"name":{"dataType":"string"},"_id":{"dataType":"string"}},"required":true},
            "room": {"dataType":"string","required":true},
            "bed": {"dataType":"string","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/api/hostels/create',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsHostelController_create, request, response });
        ...
        app.put('/api/hostels/update',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsHostelController_update, request, response });
        ...
        app.post('/api/guests/create',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsGuestController_create, request, response });
        ...
        app.put('/api/guests/update',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsGuestController_update, request, response });
        ...
        app.post('/api/guests/photos',
            ...(fetchMiddlewares<RequestHandler>(GuestController)),
            ...(fetchMiddlewares<RequestHandler>(GuestController.prototype.updatePhoto)),

            async function GuestController_updatePhoto(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsGuestController_updatePhoto, request, response });
        ...
        app.put('/api/events/:eventId/update',
            ...(fetchMiddlewares<RequestHandler>(EventsController)),
        ...
        app.delete('/api/events/:eventId/:hostelId/delete',
            ...(fetchMiddlewares<RequestHandler>(EventsController)),
