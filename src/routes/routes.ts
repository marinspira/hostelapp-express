...
const models: TsoaRoute.Models = {
  ...
  IReservationByIdResponse: {
    ...
    properties: {
      ...
      data: {
        dataType: 'union',
        subSchemas: [{ ref: 'IReservationDocument' }, { dataType: 'enum', enums: [null] }],
      },
      message: { dataType: 'string', required: true },
    },
    additionalProperties: true,
  ...
  INotificationDTO: {
    dataType: 'refObject',
    properties: {
      recipient: { ref: 'mongoose.Types.ObjectId', required: true },
      read: { dataType: 'boolean', required: true },
      type: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['reservation_created'] },
          { dataType: 'enum', enums: ['reservation_cancelled'] },
          { dataType: 'enum', enums: ['guest_checkedout'] },
          { dataType: 'enum', enums: ['event_created'] },
          { dataType: 'enum', enums: ['message_received'] },
        ],
        required: true,
      },
  ...
  INotificationListItemResponse: {
    ...
    properties: {
      success: { dataType: 'boolean', required: true },
      data: { dataType: 'array', array: { dataType: 'refObject', ref: 'INotificationDTO' } },
      message: { dataType: 'string', required: true },
    },
    additionalProperties: true,
  },
  ...
  GetEventByIdResponse: {
    ...
    properties: {
      success: { dataType: 'boolean', required: true },
      data: { ref: 'IEventDocument', required: true },
      message: { dataType: 'string', required: true },
    },
    additionalProperties: true,
  },
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    '/api/reservations/current-guests',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(ReservationController),
    ...
    async function ReservationController_list(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReservationController_list,
          request,
          response,
        });
  ...
  app.get(
    '/api/reservations/guest/current-stay',
    authenticateMiddleware([{ jwt: [] }]),
  ...
  app.get(
    '/api/reservations/guest/:hostelId/reservations',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(GuestReservationController),
    ...fetchMiddlewares<RequestHandler>(GuestReservationController.prototype.list),

    async function GuestReservationController_list(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestReservationController_list,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsHostelController_getMyHostel: Record<string, TsoaRoute.ParameterSchema> = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
  };
  app.get(
    '/api/hostels/mine',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(HostelController),
    ...fetchMiddlewares<RequestHandler>(HostelController.prototype.getMyHostel),

    async function HostelController_getMyHostel(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHostelController_getMyHostel,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsGuestController_getMyProfile: Record<string, TsoaRoute.ParameterSchema> = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
  };
  app.get(
    '/api/guests/me',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(GuestController),
    ...fetchMiddlewares<RequestHandler>(GuestController.prototype.getMyProfile),

    async function GuestController_getMyProfile(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestController_getMyProfile,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function GuestController_deleteGuest(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestController_deleteGuest,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsEventsController_getEventDetails: Record<string, TsoaRoute.ParameterSchema> = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
    eventId: { in: 'path', name: 'eventId', required: true, dataType: 'string' },
  };
  app.get(
    ...
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(EventsController),
    ...fetchMiddlewares<RequestHandler>(EventsController.prototype.getEventDetails),

    async function EventsController_getEventDetails(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsEventsController_getEventDetails,
          request,
          response,
        });
