...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { HostelController } from './../controllers/hostel.controller.new';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
const models: TsoaRoute.Models = {
  'mongoose.FlattenProperty_mongoose.Default__v_mongoose.Require_id_DocType___91__id_93__': {
    dataType: 'refAlias',
    type: {
      ref: 'mongoose.FlattenProperty_mongoose.Default__v_mongoose.Require_id_DocType___91__id_93__',
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  'mongoose.FlattenProperty_mongoose.Default__v_mongoose.Require_id_DocType___91___v_93__': {
    dataType: 'refAlias',
    type: {
      ref: 'mongoose.FlattenProperty_mongoose.Default__v_mongoose.Require_id_DocType___91___v_93__',
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ...
  Partial_IReservation_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        hostel_id: { ref: 'mongoose.Types.ObjectId' },
        user_id_guest: { ref: 'mongoose.Types.ObjectId' },
        room: { dataType: 'string' },
        bed: { dataType: 'string' },
        checkin_date: { dataType: 'datetime' },
        checkout_date: { dataType: 'datetime' },
  ...
  Partial_IHostel_: {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: {
        status: { ref: 'HostelStatus' },
        stripeAccountId: { dataType: 'string' },
        ...
        experience_with_volunteers: { dataType: 'boolean' },
        currency: { dataType: 'string' },
        rooms: {
          dataType: 'array',
          array: { dataType: 'refAlias', ref: 'mongoose.Types.ObjectId' },
        },
        user_id_owners: {
          dataType: 'array',
          array: { dataType: 'refAlias', ref: 'mongoose.Types.ObjectId' },
  ...
  Partial_IGuest_: {
    ...
    type: {
      ...
      nestedProperties: {
        name: { dataType: 'string' },
        username: { dataType: 'string' },
        guest_photos: { dataType: 'array', array: { dataType: 'string' } },
        phone: { dataType: 'string' },
        birthday: { dataType: 'datetime' },
        country: { dataType: 'string' },
        showProfileAuthorization: { dataType: 'boolean' },
        user: { ref: 'mongoose.Types.ObjectId' },
        reservations: {
          dataType: 'array',
          array: { dataType: 'refAlias', ref: 'mongoose.Types.ObjectId' },
        },
        passaportPhoto: { dataType: 'string' },
        interests: { dataType: 'array', array: { dataType: 'string' } },
        description: { dataType: 'string' },
        languages: { dataType: 'array', array: { dataType: 'string' } },
        digitalNomad: { dataType: 'boolean' },
        smoker: { dataType: 'boolean' },
        pets: { dataType: 'boolean' },
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  BackendResponse_Partial_IGuest__: {
    dataType: 'refObject',
    properties: {
      success: { dataType: 'boolean', required: true },
      data: { ref: 'Partial_IGuest_' },
      message: { dataType: 'string', required: true },
    },
    additionalProperties: true,
  },
  ...
  'BackendResponse__imagePath-string__': {
    ...
    properties: {
      ...
      data: {
        dataType: 'nestedObjectLiteral',
        nestedProperties: { imagePath: { dataType: 'string', required: true } },
      },
      message: { dataType: 'string', required: true },
    },
    additionalProperties: true,
  ...
  IEventAttendee: {
    ...
    properties: {
      _id: {
        dataType: 'union',
        subSchemas: [{ ref: 'mongoose.Types.ObjectId' }, { dataType: 'string' }],
        required: true,
      },
...
export function RegisterRoutes(app: Router) {
  ...
  app.post(
    ...
    async function ReservationController_create(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReservationController_create,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ReservationController_listAll(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReservationController_listAll,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ReservationController_findById(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReservationController_findById,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function ReservationController_update(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReservationController_update,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function ReservationController_delete(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReservationController_delete,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function ReservationController_checkout(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsReservationController_checkout,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsGuestReservationController_getCurrentReservation: Record<
    string,
  ...
  app.get(
    '/api/reservations/guest/current',
    ...
    async function GuestReservationController_getCurrentReservation(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestReservationController_getCurrentReservation,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsGuestReservationController_getReservationHistory: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
  ...
  app.get(
    '/api/reservations/guest/history',
    ...fetchMiddlewares<RequestHandler>(GuestReservationController),
    ...fetchMiddlewares<RequestHandler>(GuestReservationController.prototype.getReservationHistory),

    async function GuestReservationController_getReservationHistory(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestReservationController_getReservationHistory,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function NotificationController_getUserNotifications(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsNotificationController_getUserNotifications,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsNotificationController_getHostelNotifications: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
  ...
  app.get(
    '/notifications/hostel/:hostelId',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(NotificationController),
    ...fetchMiddlewares<RequestHandler>(NotificationController.prototype.getHostelNotifications),

    async function NotificationController_getHostelNotifications(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsNotificationController_getHostelNotifications,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function NotificationController_markAsRead(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsNotificationController_markAsRead,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function NotificationController_markAllAsReadForUser(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsNotificationController_markAllAsReadForUser,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsNotificationController_markAllAsReadForHostel: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    hostelId: { in: 'path', name: 'hostelId', required: true, dataType: 'string' },
  ...
  app.put(
    '/notifications/hostel/:hostelId/mark-all-read',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(NotificationController),
    ...fetchMiddlewares<RequestHandler>(NotificationController.prototype.markAllAsReadForHostel),

    async function NotificationController_markAllAsReadForHostel(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsNotificationController_markAllAsReadForHostel,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function NotificationController_deleteNotification(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsNotificationController_deleteNotification,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function NotificationController_getUnreadCount(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsNotificationController_getUnreadCount,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsHostelController_create: Record<string, TsoaRoute.ParameterSchema> = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
  };
  app.post(
    '/api/hostels/create',
    ...fetchMiddlewares<RequestHandler>(HostelController),
    ...fetchMiddlewares<RequestHandler>(HostelController.prototype.create),

    async function HostelController_create(request: ExRequest, response: ExResponse, next: any) {
      // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

      let validatedArgs: any[] = [];
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHostelController_create,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function HostelController_getHostel(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHostelController_getHostel,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsHostelController_update: Record<string, TsoaRoute.ParameterSchema> = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
    hostelData: { in: 'body', name: 'hostelData', required: true, ref: 'Partial_IHostel_' },
  };
  app.put(
    '/api/hostels/update',
    ...fetchMiddlewares<RequestHandler>(HostelController),
    ...fetchMiddlewares<RequestHandler>(HostelController.prototype.update),

    async function HostelController_update(request: ExRequest, response: ExResponse, next: any) {
      // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

      let validatedArgs: any[] = [];
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHostelController_update,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function HostelController_delete(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHostelController_delete,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function HostelController_getCurrentGuests(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHostelController_getCurrentGuests,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsGuestController_create: Record<string, TsoaRoute.ParameterSchema> = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
  };
  app.post(
    '/api/guests/create',
    ...fetchMiddlewares<RequestHandler>(GuestController),
    ...fetchMiddlewares<RequestHandler>(GuestController.prototype.create),

    async function GuestController_create(request: ExRequest, response: ExResponse, next: any) {
      // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

      let validatedArgs: any[] = [];
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestController_create,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function GuestController_getProfile(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestController_getProfile,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsGuestController_update: Record<string, TsoaRoute.ParameterSchema> = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
    guestData: { in: 'body', name: 'guestData', required: true, dataType: 'any' },
  };
  app.put(
    '/api/guests/update',
    ...fetchMiddlewares<RequestHandler>(GuestController),
    ...fetchMiddlewares<RequestHandler>(GuestController.prototype.update),

    async function GuestController_update(request: ExRequest, response: ExResponse, next: any) {
      // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

      let validatedArgs: any[] = [];
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestController_update,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function GuestController_searchGuests(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestController_searchGuests,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsGuestController_updatePhoto: Record<string, TsoaRoute.ParameterSchema> = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
  };
  app.post(
    '/api/guests/photos',
    ...fetchMiddlewares<RequestHandler>(GuestController),
    ...fetchMiddlewares<RequestHandler>(GuestController.prototype.updatePhoto),

    async function GuestController_updatePhoto(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestController_updatePhoto,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function GuestController_deletePhoto(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestController_deletePhoto,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function GuestController_getCurrentStay(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestController_getCurrentStay,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function EventsController_listByHostelId(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsEventsController_listByHostelId,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function EventsController_delete(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsEventsController_delete,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsGuestEventsController_listEventsForCurrentStay: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
  ...
  app.get(
    ...
    async function GuestEventsController_listEventsForCurrentStay(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestEventsController_listEventsForCurrentStay,
          request,
          response,
        });
  ...
  app.get(
    '/api/events/guest/public/:city/:country',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(GuestEventsController),
    ...fetchMiddlewares<RequestHandler>(GuestEventsController.prototype.listPublicEvents),

    async function GuestEventsController_listPublicEvents(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestEventsController_listPublicEvents,
          request,
          response,
        });
  ...
  app.post(
    '/api/events/guest/join/:eventId',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(GuestEventsController),
    ...fetchMiddlewares<RequestHandler>(GuestEventsController.prototype.joinEvent),

    async function GuestEventsController_joinEvent(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestEventsController_joinEvent,
          request,
          response,
        });
  ...
  app.post(
    '/api/events/guest/leave/:eventId',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(GuestEventsController),
    ...fetchMiddlewares<RequestHandler>(GuestEventsController.prototype.leaveEvent),

    async function GuestEventsController_leaveEvent(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsGuestEventsController_leaveEvent,
          request,
          response,
        });
