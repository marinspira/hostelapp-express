...
const countries: Country[] = [
  ...
  { country: 'Czechia (Czech Republic)', currency: 'CZK', symbol: 'Kč' },
  { country: 'Democratic Republic of the Congo', currency: 'CDF', symbol: 'FC' },
  ...
  { country: 'Eswatini (fmr. "Swaziland")', currency: 'SZL', symbol: 'E' },
  ...
  { country: 'Libya', currency: 'LYD', symbol: 'LD' },
